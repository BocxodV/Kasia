...
location: Название объекта, компании или города (строка). КРИТИЧЕСКИ ВАЖНО: НИКОГДА не переводи, не транслитерируй и не склоняй названия компаний и городов. Оставляй их строго в оригинальном виде, как они звучат или пишутся (например, 'SWISS KRONO', а не 'Швейцарское Кроно', 'Żary' или 'Жары', а не 'Шары'). Если не уверен — извлеки оригинальное слово из текста.
